...
//    public static byte[] key = {36,87,48,82,54,75,26,71,48,80,65,88,12,99,45,23};
    ...
    public static final String GET_WORK_STATUS = "com.sunshine.blelibrary.config.GET_WORK_STATUS";
    ...
    public static final String GET_ICCID_ACTION = "com.sunshine.blelibrary.config.GET_ICCID_ACTION";
    public static final String GET_IMEI_ACTION = "com.sunshine.blelibrary.config.GET_IMEI_ACTION";
    public static final String GET_DOMAIN_ACTION = "com.sunshine.blelibrary.config.GET_DOMAIN_ACTION";
    public static final String GET_DOMAIN2_ACTION = "com.sunshine.blelibrary.config.GET_DOMAIN2_ACTION";
    public static final String GET_IP_ACTION = "com.sunshine.blelibrary.config.GET_IP_ACTION";
    ...
    public static IntentFilter initFilter() {
        ...
        intentFilter.addAction(GET_WORK_STATUS);
        intentFilter.addAction(GSM_ID_ACTION);
        intentFilter.addAction(GSM_VERSION_ACTION);
        intentFilter.addAction(GET_ICCID_ACTION);
        intentFilter.addAction(GET_IMEI_ACTION);
        intentFilter.addAction(GET_DOMAIN_ACTION);
        intentFilter.addAction(GET_DOMAIN2_ACTION);
        intentFilter.addAction(GET_IP_ACTION);
